<?php pageHeader($data);?>
    ...
    <div class="col-10">
        ...
        <div class="card-body row justify-content-center" id="card-body-page">
            ...
            <div class="col-11">
                <form id="formAreaStudyObject" name="formAreaStudyObject">
                ...
                <div class="tile">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-centered table-bordered mb-0" id="areaStudyObjectTable" style="width:100%">
                        <thead>
                            <tr>
                            <th>Componente</th>
