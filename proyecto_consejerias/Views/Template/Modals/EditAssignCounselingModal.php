<div class="modal fade" id="editAssignCounselingModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formEditAssingCounseling" name="formEditAssingCounseling">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="listEditCounseling" class="col-form-label">Resultado de aprendizaje:</label>
                    <select class="form-select" id="listEditCounseling" name="listEditCounseling"></select>
                </div>
                <div class="mb-3">
