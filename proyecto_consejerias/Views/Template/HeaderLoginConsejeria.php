    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <form name="ELR" id="ELR" action="<?= baseUrl() ?>EditCounseling" method="post">
                    ...
                    <li class="nav-item">
                        <form name="EALR" id="EALR" action="<?= baseUrl() ?>EditAssignCounseling" method="post">
                                <input type="hidden" id="txtUser" name="txtUser" class="form-control"
                                value="<?= $data['user']?>" />
                                <input type="hidden" id="txtPassword" name="txtPassword" class="form-control" 
                                value="<?= $data['pass']?>"/>
                                <button id="menuBtns" class="btn btn-link" aria-current="page" type="submit">Asignación consejerias</button>
                        </form>
                    </li>
                    <li class="nav-item">
