...
<body class="d-flex flex-column min-vh-100">
    ...
    <script>const base_url = "http://localhost/res-aprendizaje8/datos/test_conceptual.php"</script>
...
Highcharts.chart('MI_grafica', {
    ...
    title: {
        text: 'Espacios por herramienta conceptual'
    },
    ...
    data: {
        // csvURL: 'http://localhost/res-aprendizaje8/datos/datos_conceptual.csv',
        csvURL: 'http://localhost/res-aprendizaje8/datos/datos_conceptual.csv',
...
data: {
        // csvURL: 'http://www.sistematizaciondatos.com.dream.website/resultados/res-aprendizaje6/datos/datos_conceptual.csv',
        csvURL: 'http://localhost/res-aprendizaje8/datos/datos_conceptual.csv',
        beforeParse: function (csv) {
            return csv.replace(/\n\n/g, '\n');
        }
