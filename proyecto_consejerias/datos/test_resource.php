...
Highcharts.chart('MI_grafica', {
    ...
    data: {
        csvURL: 'http://www.sistematizaciondatos.com.dream.website/resultados/res-aprendizaje6/datos/datos_resource.csv',
