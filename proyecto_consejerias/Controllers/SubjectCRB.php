<?php
    class SubjectCRB extends Controllers{
        public function __construct(){
            parent::__construct();
        }

        public function SubjectCRB(int $codeCR){
            ...
            $data['page_functions_js'] = "functions_conceptual_cr.js";
            $this->views->getView($this,"SubjectCRB",$data);
        }
